...
<body>
	...
	<div class="row">
		...
		<div class="bod content">
					<form:form action="${pageContext.request.contextPath}/admin/updated" method="post" class="form"
				modelAttribute="book">
				...
				<a href="${pageContext.request.contextPath}/admin/delete?parameter=${book.isbn}" class="btn" style="text-align: center; text-decoration: none;">delete</a>
			</form:form>
		</div>
	</div>
</body>
