...
<body bgcolor="#BFC9CA">
	<div class="card">
		<div class="card-header">
			<div class="text-header">Admin Login</div>
		</div>
		<div class="card-body">
			<form action="./dashboard" method="post">
				<div class="form-group">
					<label for="libraryId">Staff Id:</label> <input
						class="form-control" name="staffId" id="libraryId" type="text"
						required>
				</div>
				<div class="form-group">
			...
			<p class="signin">
					Don't have an acount ? <a href="#" style="color: red;">Signup</a>
				</p>
